...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void plans() => Navigator.push(context, MaterialPageRoute(builder: (_) => PlansScreen(onPlanActivated: () { load(); widget.onDataChanged(); })));
  void habitsPage() => Navigator.push(context, MaterialPageRoute(builder: (_) => HabitScreen(onHabitUpdated: () { load(); widget.onDataChanged(); })));
  void scanFood() => Navigator.push(context, MaterialPageRoute(builder: (_) => FoodScannerScreen(onFoodLogged: () { load(); widget.onDataChanged(); })));
  void fitness() => Navigator.push(context, MaterialPageRoute(builder: (_) => const FitnessScreen())).then((_) { load(); widget.onDataChanged(); });
